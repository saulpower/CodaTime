...
#ifndef CodaTime_DateTimeConstants_h
#define CodaTime_DateTimeConstants_h
...
public:
    ...
    static const int MILLIS_PER_MINUTE = MILLIS_PER_SECOND * SECONDS_PER_MINUTE;
    ...
    static const int MILLIS_PER_HOUR = MILLIS_PER_MINUTE * MINUTES_PER_HOUR;
    ...
    static const int MILLIS_PER_DAY = MILLIS_PER_HOUR * HOURS_PER_DAY;
    
    /** Days in one week (7) (ISO) */
    static const int DAYS_PER_WEEK = 7;
    /** Hours in a typical week. Due to time zone offset changes, the number of
     * hours per week can vary. */
    static const int HOURS_PER_WEEK = HOURS_PER_DAY * DAYS_PER_WEEK;
    ...
    static const int SECONDS_PER_WEEK = SECONDS_PER_DAY * DAYS_PER_WEEK;
    /** Milliseconds in a typical week (ISO). Due to time zone offset changes, the
     * number of milliseconds per week can vary. */
    static const int MILLIS_PER_WEEK = MILLIS_PER_DAY * DAYS_PER_WEEK;
