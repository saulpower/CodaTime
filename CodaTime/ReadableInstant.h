...
#ifndef CodaTime_ReadableInstant_h
#define CodaTime_ReadableInstant_h
 ...
 * @since 1.0
 */
class ReadableInstant : public Comparable<ReadableInstant>, public virtual Object {
...
public:
     ...
     */
    virtual DateTimeZone *getZone() = 0;
     ...
     */
    virtual int get(const DateTimeFieldType *type) const = 0;
     ...
     */
    virtual bool isSupported(DateTimeFieldType *field) = 0;
     ...
     */
    virtual bool isEqual(ReadableInstant *instant) = 0;
     ...
     */
    virtual bool equals(const Object *readableInstant) const = 0;
